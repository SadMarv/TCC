angular.module('UserDirectory').factory('Auth', function(FURL, $log, $firebaseAuth, $firebaseArray, $firebaseObject, Utils) {
		...
		resetpassword: function(email) {
			return auth.$sendPasswordResetEmail(
				  email
					...
					Utils.alertshow("Pronto.","A chave foi enviada ao seu email.");
