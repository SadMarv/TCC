...
angular.module('UserDirectory').controller('AtividadesUserIDCtrl', function(turmas, itemsAtiv, ionicDatePicker, $stateParams, $state, $scope, $log, $ionicActionSheet, $ionicPopup, $location, $filter, moment, Utils) {
  var vm = this;
